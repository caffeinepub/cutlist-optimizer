...
export class Backend implements backendInterface {
    ...
    async countProjects(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countProjects();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createProject(arg0: string, arg1: Array<Sheet>, arg2: Array<Piece>): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getAllProjectsAdmin(): Promise<Array<[Principal, Project]>> {
        if (this.processError) {
            try {
    ...
    async getUserProjectsAdmin(arg0: Principal): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserProjectsAdmin(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProject(arg0: string, arg1: string, arg2: Array<Sheet>, arg3: Array<Piece>): Promise<void> {
        if (this.processError) {
            try {
